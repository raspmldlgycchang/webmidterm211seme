...
savename="<이번프로젝트있는폴더>/<이번프로젝트명>/weeksubmit/public/html/ggssing_detail.html"
#print(savename)
...
#a 태그가 저 패턴과 일치하는 경우의 img태그의 src만을 불러온다
...
#this is for static_page.html button onclick method where to link to
#button(not related to this python file)
f_srcList_path = '<이번프로젝트있는폴더>/<이번프로젝트명>/weeksubmit/public/pathTxt/srcList.txt'
...
#        savename="<이번프로젝트있는폴더>/<이번프로젝트명>/weeksubmit/public/images/GogosingImg/gogosingimg"+str(i)+".png"
#        print(savename)
...
for i in range(len(matched_img_List)):#there are no None Image!
    savename = "<이번프로젝트있는폴더>/<이번프로젝트명>/weeksubmit/public/images/GogosingImg_detail/gogosing"+str(i)+".png"
    print(savename)
    dirname = os.path.dirname(savename)
    if not os.path.exists(dirname):
        os.makedirs(dirname)
    ...
    #savename_ = '<이번프로젝트있는폴더>/<이번프로젝트명>/weeksubmit/public/binaryimages/GogosingBinImg/gogosingimg/1.png'
...
#    savename = "<이번프로젝트있는폴더>/<이번프로젝트명>/weeksubmit/public/images/GogosingImg/gogosing"+str(i)+".png"
#    print(savename)
#    dirname = os.path.dirname(savename)
#    #if not os.path.exists(dirname):
#    #    os.makedirs(dirname)
